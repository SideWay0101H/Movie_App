...
class Movie {
  ...
  factory Movie.formEntity(MovieEntity entity, List<Genre> genres) {
    return Movie(
        title: entity.title,
  ...
  @override
  String toString() {
    return 'Movie(title: $title, oveview: $overview, voteAverage: $voteAverage, genres: $genres, releaseDate: $releaseDate,backdropPath: $backdropPath, posterPath: $posterPath)';
  }
